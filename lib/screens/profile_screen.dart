  ...
  Future<void> _loadUserData() async {
    ...
    if (data != null && mounted) {
      setState(() {
        ...
        _userName = data['name'] ?? user.displayName ?? 'Citizen';
      });
    }
  }
  ...
  Future<void> _changePhoto() async {
    ...
    try {
      ...
      final request = http.MultipartRequest('POST', uri)
        ...
        ..fields['public_id'] = 'bantay_daan/users/${user.uid}'
      ...
      if (response.statusCode == 200) {
        final photoUrl = body['secure_url'] as String;
            ...
            child: Row(children: [
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          shape: BoxShape.circle,
                          border: Border.all(
                              color: AppColors.navySurface, width: 1.5),
                        ),
                        child: const Icon(Icons.camera_alt,
                            color: AppColors.navyDeep, size: 11),
                      ),
                    ),
                  ),
                ],
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      _userName ?? user.displayName ?? 'Citizen',
